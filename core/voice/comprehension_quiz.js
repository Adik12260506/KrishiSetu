    ...
    options: [
      {
        option_id: '1',
        keypad_key: '1',
        voice_keywords: ['yes', 'haan', 'ha', 'avunu', 'sahi', 'true', 'right'],
        text: { en: '1: Yes, automatic payout (हाँ)', hi: '1: हाँ, स्वतः भुगतान मिलेगा', te: '1: అవును, పరిహారం అందుతుంది' },
        is_correct: true
      },
      {
        option_id: '2',
        keypad_key: '2',
        voice_keywords: ['no', 'nahi', 'ledu', 'galat', 'false', 'wrong'],
        text: { en: '2: No payout (नहीं)', hi: '2: नहीं, भुगतान नहीं मिलेगा', te: '2: లేదు, పరిహారం అందదు' },
        is_correct: false
      }
    ],
    explanation: {
    ...
    options: [
      {
        option_id: '1',
        keypad_key: '1',
        voice_keywords: ['yes', 'haan', 'ha', 'avunu', 'sahi', 'true'],
        text: { en: '1: Yes, works completely offline (हाँ)', hi: '1: हाँ, ऑफलाइन भी काम करेगा', te: '1: అవును, ఆఫ్‌లైన్‌లో కూడా పనిచేస్తుంది' },
        is_correct: true
      },
      {
        option_id: '2',
        keypad_key: '2',
        voice_keywords: ['no', 'nahi', 'ledu', 'galat'],
        text: { en: '2: No, internet is required (नहीं)', hi: '2: नहीं, इंटरनेट जरूरी है', te: '2: లేదు, ఇంటర్నెట్ కావాలి' },
        is_correct: false
      }
    ],
    explanation: {
